...
copyright = '2022, Daniele Coslovich, Francesco Turci'
author = 'Daniele Coslovich, Francesco Turci'
...
html_theme_options = {
    ...
    'extra_nav_links': {'Public API': 'https://atooms.frama.io/postprocessing/api/postprocessing',
                        'Notebooks on Framagit': 'https://atooms.frama.io/postprocessing/'},
    'gray_2': '#F4F4F4ED',
    'sidebar_width': '270px',
    'body_max_width': 'auto',
    'page_width': '1100px',
